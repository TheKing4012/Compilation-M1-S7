// UPP.java
// Lisa Savy - MEEF
// Marie Dechambre - MEEF
// Richard Picole-Ollivier - PAS MEEF et GL
...
class UPPTrue extends UPPExpr {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
                   ArrayList<String> globals, PRegister reg, RTLInst succ) {/***/
        //To do
        RTLCte rltTrue = new RTLCte(reg, 1, succ);
        return rltTrue;
    }//toRTL
...
class UPPFalse extends UPPExpr {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
                   ArrayList<String> globals, PRegister reg, RTLInst succ) {/***/
        //To do
        RTLCte rltFalse = new RTLCte(reg, 0, succ);
        return rltFalse;
    }//toRTL
...
class UPPGVar extends UPPExpr {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
                   ArrayList<String> globals, PRegister reg, RTLInst succ) {/***/
        //To do
        RTLGetGVar rltGVar = new RTLGetGVar(reg, name, succ);
        return rltGVar;
    }//toRTL
...
class UPPNot extends UPPUnOp {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
        ...
        RTLUnOp rtlNot = new RTLXOri(reg, regE, succ);
        return rtlNot;
    }//toRTL
...
class UPPLoad extends UPPExpr {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
                   ArrayList<String> globals, PRegister reg, RTLInst succ) {/***/
        //To do
        PRegister regVal = addr.getPRegister(locals);
        return new RTLLoad(regVal, reg, succ);
    }//toRTL
...
class UPPCond extends UPPInst {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
        ...
        RTLInst i1 = i1.toRTL(locals,globals,succ);
        RTLInst i2 = i2.toRTL(locals,globals,succ);
        RTLGtz gtz = new RTLGtz(regCond,i1,i2);
...
class UPPProcCall extends UPPInst {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
        ...
        for (UPPExpr e : args)
            regs.add(e.getPRegister(locals));
        RTLInst proc = new RTLProcCall(callee,regs,reg,succ);
        RTLInst acc = proc;
        for (int i = args.size() - 1; i >= 0; i--)
            acc = args.get(i).toRTL(locals,globals,regs.get(i),acc);
        return acc;
...
class UPPSeq extends UPPInst {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
                   ArrayList<String> globals, RTLInst succ) { /***/
        //To do
        RTLInst ni2 = i2.toRTL(locals,globals,succ); //En RTL on a plus de séquence car les pointeurs se suivent, donc une séquence = 1 element point sur son succéseur ect...
