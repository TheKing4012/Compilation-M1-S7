...
//
//    UPPExpr toUPP(ArrayList<String> locals) {/*CHANGES*/
//        return new UPPTrue();
//    }//toUPP
//
//}//PPTrue
...
class PPInv extends PPUnOp {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {/*CHANGES*/
        UPPExpr e1 = e.toUPP(locals);
        UPPCte zero = new UPPCte(0);
        return new UPPSub(zero,e1);
    }//toUPP
...
class PPLt extends PPBinOp {/*CHANGES*/
...
class PPArrayGet extends PPExpr {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {/*CHANGES*/
        ...
        UPPExpr nind = index.toUPP(locals);
        UPPExpr res = new UPPAdd(narr, new UPPMul(new UPPCte(4), nind));
...
class PPArraySet extends PPInst {
    ...
    UPPInst toUPP(ArrayList<String> locals) {/*CHANGES*/
        UPPExpr nval = val.toUPP(locals);
        UPPExpr narr = arr.toUPP(locals);
        UPPExpr nind = index.toUPP(locals);
        UPPExpr res = new UPPAdd(narr, new UPPMul(new UPPCte(4), nind));
        return new UPPStore(res, nval);
    }//toUPP
...
class PPProcCall extends PPInst {
    ...
    UPPInst toUPP (ArrayList<String> locals) {/*CHANGES*/
        ArrayList<UPPExpr> UPPargs = new ArrayList<>();
        for (PPExpr pp: args) {
            UPPargs.add(pp.toUPP(locals));
        }
        return new UPPProcCall(callee, UPPargs);
    }//toUPP
...
class PPProc extends PPDef {
    ...
    UPPDef toUPP () { /*CHANGES*/
        ArrayList<String> UPPArgs = new ArrayList<>();
        ArrayList<String> UPPLocals = new ArrayList<>();
        ArrayList<String> UPPAll = new ArrayList<>();
        UPPInst UPPCode;
        ...
        UPPAll.add(name);
        for (Pair<String,Type> e : locals) {
            UPPLocals.add(e.left);
            UPPAll.add(e.left);
        }//for

        UPPCode = code.toUPP(UPPAll);
        return new UPPProc(name,UPPArgs,UPPLocals,UPPCode);
    }//toUPP
